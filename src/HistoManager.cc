...
HistoManager::HistoManager() :
		fFileName("SourceSimulation_Sr90_SensorGeometry_300um")
{
...
void HistoManager::book()
{
	...
	const G4String title[] =
		{ "Primary energy distribution", //0
				...
				"Sensor dE/dx",//12
				"Particle energy at trigger", //13,
				"Trigger energy deposit",//14
			};
	...
	dataType.push_back("Energy");//13
	dataType.push_back("Energy");//14
